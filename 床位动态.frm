...
Mrc.Open "select * from 床位动态 where 病床分区='" & 护士工作站MDI.StatusBar1.Panels(4).Text & "'order by '床位号'", Con, adOpenKeyset, adLockOptimistic
